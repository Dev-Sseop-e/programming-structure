...
# 16 "decomment.c"
                                                  , "%c", get); state = out;}
                else if(get == '/') state = slash;
                else if(get==34) {fprintf(
# 18 "decomment.c" 3 4
                                         stdout
# 18 "decomment.c"
                                               , "%c", get); state = in_str1;}

                else if(get==39) {fprintf(
# 20 "decomment.c" 3 4
                                         stdout
# 20 "decomment.c"
                                               , "%c", get); state = in_str2;}
...
# 60 "decomment.c"
                ...
                else if(get==92) {fprintf(
# 62 "decomment.c" 3 4
                                         stdout
# 62 "decomment.c"
                                               , "%c", get); state = backslash1;}
